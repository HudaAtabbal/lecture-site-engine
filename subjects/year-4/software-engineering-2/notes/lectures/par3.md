...
## ملخص: الفقرة 0أ: Design مقابل Implementation + متى نوثّق رسمياً
...
## أسئلة اختيار من متعدد (MCQ) — الفقرة 0أ: Design مقابل Implementation + متى نوثّق رسمياً
...
## ملخص: الفقرة 0ب: خطوات التصميم الكائني التوجه الخمس (OOD Steps)
...
## أسئلة اختيار من متعدد (MCQ) — الفقرة 0ب: خطوات التصميم الكائني التوجه الخمس (OOD Steps)
...
## ملخص: الفقرة 0ج: Structural مقابل Dynamic Models + Interface Specification
...
## ملخص: الفقرة 0د: Host-Target Development
...
## أسئلة اختيار من متعدد (MCQ) — الفقرة 0د: Host-Target Development
...
## ملخص: الفقرة 1: Use Case + النماذج الديناميكية مقابل الساكنة
...
## أسئلة اختيار من متعدد (MCQ) — الفقرة 1: Use Case + النماذج الديناميكية مقابل الساكنة
...
## ملخص: الفقرة 2: مستويات إعادة الاستخدام (Reuse Levels)

**من المحاضرة:** محاضرة 4، §4.1 | 4 مستويات: Abstraction ← Object ← Component ← System (من الأبسط للأعقد).

---

## أسئلة اختيار من متعدد (MCQ) — الفقرة 2: مستويات إعادة الاستخدام (Reuse Levels)
...
## ملخص: الفقرة 3: فوائد ومشاكل إعادة الاستخدام

**من المحاضرة:** محاضرة 4، §4.1

---

## أسئلة اختيار من متعدد (MCQ) — الفقرة 3: فوائد ومشاكل إعادة الاستخدام
...
## ملخص: الفقرة 4: Configuration Management + Version Control
...
## أسئلة اختيار من متعدد (MCQ) — الفقرة 4: Configuration Management + Version Control
...
## ملخص: الفقرة 5: مراحل التطوير والصيانة (Maintenance)

**من المحاضرة:** محاضرة 4، §4.3 (مرتبط بمحاضرة 1، Software Evolution)

---

## أسئلة اختيار من متعدد (MCQ) — الفقرة 5: مراحل التطوير والصيانة (Maintenance)
