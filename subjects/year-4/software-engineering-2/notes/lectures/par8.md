...
## ملخص: الفقرة 0أ: تعريف Refactoring + ما هو ليس Refactoring
...
## ملخص: الفقرة 0ب: لماذا ومتى نُرفكتِر
...
## ملخص: الفقرة 0ج: البرامج السهلة (خصائص الكود الصعب)
...
## ملخص: الفقرة 0د: Code Smells وحلولها (الجدول الأهم بالمحاضرة)
...
## أسئلة اختيار من متعدد (MCQ) — الفقرة 0د: Code Smells وحلولها (الجدول الأهم بالمحاضرة)
...
## ملخص: الفقرة 0ه: دورة Refactoring (Refactoring Cycle)
...
## ملخص: الفقرة 0و: تقنيات Refactoring التفصيلية — Extract/Inline + Replace
...
## أسئلة اختيار من متعدد (MCQ) — الفقرة 0و: تقنيات Refactoring التفصيلية — Extract/Inline + Replace
...
## ملخص: الفقرة 1: تعريف Refactoring + الفيصل معه (السلوك الخارجي)

**من المحاضرة:** محاضرة 13، §1-2 | `Refactoring`: تغيير البنية الداخلية **بدون** تغيير السلوك الخارجي.

---

## أسئلة اختيار من متعدد (MCQ) — الفقرة 1: تعريف Refactoring + الفيصل معه (السلوك الخارجي)
...
## ملخص: الفقرة 3: طرق Refactoring — Extract / Inline / Replace
...
## أسئلة اختيار من متعدد (MCQ) — الفقرة 3: طرق Refactoring — Extract / Inline / Replace
