...
## ملخص: الفقرة 1: تعريف اللعبة (Adams + Salen & Zimmerman)
...
## أسئلة اختيار من متعدد (MCQ) — الفقرة 1: تعريف اللعبة (Adams + Salen & Zimmerman)
...
## ملخص: الفقرة 3: طول جلسة اللعب (Play Length)
...
## أسئلة اختيار من متعدد (MCQ) — الفقرة 3: طول جلسة اللعب (Play Length)
...
## ملخص: الفقرة 4: Narrative مقابل Ludic
...
## أسئلة اختيار من متعدد (MCQ) — الفقرة 4: Narrative مقابل Ludic
...
## ملخص: الفقرة 5: التوازن (Motivate + Empower) + توجّه المقرر
...
## أسئلة اختيار من متعدد (MCQ) — الفقرة 5: التوازن (Motivate + Empower) + توجّه المقرر
...
## ملخص: الفقرة 7: استكشاف الألعاب + الأهداف الواقعية (Quality over Quantity)
...
## أسئلة اختيار من متعدد (MCQ) — الفقرة 7: استكشاف الألعاب + الأهداف الواقعية (Quality over Quantity)
