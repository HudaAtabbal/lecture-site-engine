...
## ملخص: الفقرة 0أ: مصطلحات الجدولة الأساسية
...
## ملخص: الفقرة 3ب: فريق التطوير وتنظيمه
...
## ملخص: الفقرة 6ب: تصنيف المخاطر (المصدر/التأثير) + Risk Checklist
...
## أسئلة اختيار من متعدد (MCQ) — الفقرة 6ب: تصنيف المخاطر (المصدر/التأثير) + Risk Checklist
...
## ملخص: الفقرة 6ج: استراتيجيات التعامل مع المخاطر (Risk Handling)
...
## ملخص: الفقرة 1: WBS + CPM + تقدير المدة والاعتماديات

**من المحاضرة:** محاضرة 7، §4-6 | `CPM` (طريقة المسار الحرج): يحدد النشاط اللي `Slack = 0`.

---

## أسئلة اختيار من متعدد (MCQ) — الفقرة 1: WBS + CPM + تقدير المدة والاعتماديات
...
## ملخص: الفقرة 2: تقدير الجهد — Bottom-up + PERT

**من المحاضرة:** محاضرة 7، §9-10 | `PERT`: معادلة `(x + 4z + y) / 6` (متشائم + 4×الأكثر احتمالاً + متفائل ÷ 6).

---

## أسئلة اختيار من متعدد (MCQ) — الفقرة 2: تقدير الجهد — Bottom-up + PERT
...
## ملخص: الفقرة 3: Gantt Chart + Resource Leveling

**من المحاضرة:** محاضرة 7، §7-8

---

## أسئلة اختيار من متعدد (MCQ) — الفقرة 3: Gantt Chart + Resource Leveling
...
## ملخص: الفقرة 4: إدارة المخاطر — Identification / Assessment / Analysis

**من المحاضرة:** محاضرة 7، §11-15 | `Risk Exposure = Probability × Impact`. المراحل: Identification → Analysis → Control.

---

## أسئلة اختيار من متعدد (MCQ) — الفقرة 4: إدارة المخاطر — Identification / Assessment / Analysis
...
## ملخص: الفقرة 5: خطة المشروع (Project Plan)

**من المحاضرة:** محاضرة 7، §16 | وثيقة من 14 بنداً تعمل كـ"عقد غير رسمي" لكيفية تنفيذ ومراقبة المشروع.

---

## أسئلة اختيار من متعدد (MCQ) — الفقرة 5: خطة المشروع (Project Plan)
